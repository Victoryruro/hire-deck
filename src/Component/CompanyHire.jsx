...
export const CATEGORIES = [
  ...
  },
  {
    ...
    {
    name: 'FinEdge Capitals',
    slug:'Financial Services2',
    count: 15,
    location:"Chicago",
    icon: icon,
  },
    {
    name: 'FinEdge Capitalss',
    slug:'Financial Services3',
    count: 15,
    location:"Chicago",
    icon: icon,
  },
    {
    name: 'DesignCraft Studio2',
    slug:'Creative Agency4',
    count: 12,
    location:"New York,NY",
    icon: icon,
  },
    {
    name: 'DesignCraft Studio3',
    slug:'Creative Agency5',
    count: 12,
    location:"New York,NY",
    icon: icon,
  },
    {
    name: 'DesignCraft Studio4',
    slug:'Creative Agency6',
    count: 12,
    location:"New York,NY",
    icon: icon,
  },
    {
    name: 'CloudPeak Systems2',
    slug:'Cloud Infastructure4',
    count: 31,
    location:"Austin , TX",
    icon: icon,
  },
