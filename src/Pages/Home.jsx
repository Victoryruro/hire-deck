...
const Home = () => {
  return (
    <>
        <div className="w-full pb-30  flex flex-col flex-nowrap justify-start mt-14 pt-30 md:pt-63 items-center bg-linear-to-br from-[#4c42dc] to-[#7123bb] to-99% dark:bg-linear-to-br dark:from-[#4c42dc] dark:to-[#101828]! dark:to-99%  transition-colors duration-300">
          <StatsBar persons={2500} companies={340} />
          <div className="flex flex-col items-center justify-center mb-5 ">
            <h1 className="text-5xl md:text-8xl font-bold text-white text-center mt-10 mb-10 tracking-tight">Find Your Dream Job</h1>
            <p className="text-2xl md:text-3xl font-mono md:font-semibold text-[#e0e7ff] text-center mt-4 pb-3">Search thousands of opportunities from top companies worldwide.<br />Your next career move starts here.</p>
          </div>
          <JobSearchFilters/> 
